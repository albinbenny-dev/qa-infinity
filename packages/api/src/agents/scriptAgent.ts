...
Locator priority: getByTestId > locator('[id="value"]') > getByRole > getByLabel > CSS. Never use XPath.
...
- SELECTOR heals: the listed selector was unstable. Prefer getByTestId/locator('[id="value"]')/getByRole/getByLabel over it.
